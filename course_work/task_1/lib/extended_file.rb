...
class File
  def self.divide_on_10_parts(path)
  ...
  def self.divider_10_parts(path)
  ...
  def self.creating_10_parts(path, parts_amount, origin_file_content, indexes_for_parts_var)
  ...
  def self.indexes_for_parts(part_size, rest_data_size)
